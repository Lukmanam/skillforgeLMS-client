  ...
  return (
    <div>
      ...
      <img className="mx-auto w-1/5" src="/assets/oops.jpg" alt="photo here" />
        ...
        <Link to="/instructor" className="bg-blue-500 text-white px-6 py-3 rounded-full text-xl font-bold hover:bg-blue-600 transition duration-300">Go to Home</Link>
      </div>
    </div>
    </div>
  )
