...
const Conversation = ({ currentinstructor, message }) => {

  return (
    <div id="messages" className="">
      {currentinstructor === message?.senderId ? (
        ...
        <div className="chat-message">
          <div className="flex items-end">
            <div className="flex flex-col space-y-2 text-xs max-w-xs mx-2 order-2 items-start">
              <div>
                <span
                  className="px-4 py-2 rounded-lg inline-block rounded-bl-none bg-white text-gray-600 break-words"
                  style={{ maxWidth: "350px" }}
                >
                  {message?.text}
                </span>
